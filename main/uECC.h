...
extern const int sizeofCurve;
    ...
    */
    //uECC_RNG_Function uECC_get_rng(uECC_Curve curve);
    ...
    */
    int uECC_make_key(uint8_t* public_key, uint8_t* private_key, uECC_Curve curve, uECC_RNG_Function g_rng_function);
